...
<<<<<<< HEAD:core/api/src/main/java/org/onosproject/net/behaviour/inbandtelemetry/IntDeviceConfig.java
                    sinkIp, sinkMac, spec, enabled, minFlowHopLatencyChangeNs);
=======
                                 sinkIp, sinkMac, spec, enabled, minFlowHopLatencyChangeNs);
>>>>>>> origin/master:core/api/src/main/java/org/onosproject/net/behaviour/inbandtelemetry/IntDeviceConfig.java
        }
    }
}
